        ...
        while (true) {
            if (continuePlaying && archivo != null) {
                try {
                    ...
                    Integer fps = Integer.parseInt(archivo.split("\\.\\.\\.")[1].split("\\.")[0]);
                    ...
                    while ((frame = g.grab()) != null && continuePlaying) {
                        if (frame.image != null) {
                            ...
                            if (buf != null) {
                                ...
                                interObservable.sendStream(utils.encodeBytesToBase64String(imageInByte), server);
                    ...
                    observable.cambiarMensaje("stop");
